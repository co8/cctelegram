...
```bash
# Download and extract latest bridge (v0.6.0)
curl -L https://github.com/co8/cctelegram/releases/download/v0.6.0/cctelegram-bridge-v0.6.0-source.tar.gz -o cctelegram-bridge-v0.6.0-source.tar.gz
tar -xzf cctelegram-bridge-v0.6.0-source.tar.gz
cd cctelegram-bridge-v0.6.0
cargo build --release
