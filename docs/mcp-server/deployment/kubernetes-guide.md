...
spec:
  ...
  template:
    ...
    spec:
      ...
      containers:
      - name: mcp-server
        image: ghcr.io/your-org/cctelegram-mcp-server:v1.8.5
...
# Update deployment
kubectl set image deployment/cctelegram-mcp-server mcp-server=ghcr.io/your-org/cctelegram-mcp-server:v1.8.5 -n cctelegram
